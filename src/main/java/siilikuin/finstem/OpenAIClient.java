...
public class OpenAIClient {
    ...
    public String[] getExampleSentences(Language language, String word) throws IOException, SQLException {
        ...
        try (Response response = httpClient.newCall(request).execute()) {
            ...
            String[] sentences = parseSentences(responseJson);
            storeSentencesInDatabase(word, sentences);
            return sentences;
        }
    }
    ...
    /**
     * Stores the sentences in the SQLite database.
     * @param word the word for which the example sentences were generated
     * @param sentences the example sentences generated by the API
     * @throws SQLException if a database access error occurs
     */
    private void storeSentencesInDatabase(String word, String[] sentences) throws SQLException {
        String url = "jdbc:sqlite:sentences.db";

        try (Connection conn = DriverManager.getConnection(url);
             Statement stmt = conn.createStatement()) {

            // Create table if not exists
            String createTableSQL = "CREATE TABLE IF NOT EXISTS sentences (" +
                    "word TEXT NOT NULL, " +
            ...
            String insertSQL = "INSERT INTO sentences(word, sentence, translation) VALUES(?, ?, ?)";
